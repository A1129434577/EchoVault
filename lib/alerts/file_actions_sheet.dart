              ...
              children: [
                ...
                Container(
                  ...
                  child: CupertinoButton(
                    ...
                    child: Image.asset(Assets.otherClose, width: 20),
                  ),
                )
              ],
            ),
                    ...
                    child: Row(
                      ...
                      children: [
                        SaveFileWidget(
                          ...
                          icon: Assets.otherAlertSave,
                          selectedIcon: Assets.otherAlertSaveS,
                        ),
                        Text(
                          title,
                          style: TextStyle(
                    ...
                    child: Row(
                      ...
                      children: [
                        FavoriteFileWidget(
                          ...
                          icon: Assets.otherAlertLike,
                          selectedIcon: Assets.otherAlertLikeS,
                        ),
                        Text(
                          title,
                          style: TextStyle(
                ...
                return GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Row(
                      spacing: 16,
                      children: [
                        Image.asset(Assets.otherAlertPlayNext),
                        Text(
                          title,
                          style: TextStyle(
                            fontSize: 12,
                ...
                return GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Row(
                      spacing: 16,
                      children: [
                        Image.asset(Assets.otherAlertAddQueue),
                        Text(
                          title,
                          style: TextStyle(
                            fontSize: 12,
                ...
                return GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Row(
                      spacing: 16,
                      children: [
                        Image.asset(Assets.otherAlertAddplaylist),
                        Text(
                          title,
                          style: TextStyle(
                            fontSize: 12,
                ...
                return GestureDetector(
                  ...
                  child: SizedBox(
                    ...
                    child: Row(
                      spacing: 16,
                      children: [
                        Image.asset(Assets.otherIconUser),
                        Text(
                          title,
                          style: TextStyle(
                            fontSize: 12,

    ...
    for (var key in parseKeys) {
      try {
        ...
        if (key is String) {
          ...
          int? index = key[ParseUtil.indexKey];
          String? filterKey = key[ParseUtil.filterKey];
          String? filterValue = key[ParseUtil.filterValueKey];
          Map? filters = key[ParseUtil.filtersKey];
          if (index != null) {
            ...
            String? filterKey = filters[ParseUtil.filtersKey];
            String? childKey = filters[ParseUtil.filterChildKey];
            String? childValue = filters[ParseUtil.filterChildValueKey];
            List filteredList = [];
            for (var e in data) {
              if (e is Map) {

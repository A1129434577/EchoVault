...
part 'file_group.g.dart';

enum FileGroupShowType {
...
class FileGroup {
  ...
  factory FileGroup.fromJson(Map<String, dynamic> srcJson) => _$FileGroupFromJson(srcJson);

  Map<String, dynamic> toJson() => _$FileGroupToJson(this);
}
  ...
  Widget build(BuildContext context) {
    ...
    return SliderTheme(
      data: SliderThemeData(
        ...
        _ThumbShape(imgName: thumbImgName, size: thumbSize!):null,
        //轨道形状
...
class _ThumbShape extends SliderComponentShape {
  ...
  Size getPreferredSize(bool isEnabled, bool isDiscrete) {
    return size.isEmpty?size:Size(max(size.width, 20), max(size.height, 20)); // 设置 thumb 的大小
  }
...
class RoundedRectSliderTrackShape extends SliderTrackShape {
  ...
  void paint(
    ...
    final secondaryActiveTrackColor = sliderTheme.secondaryActiveTrackColor ?? Colors.blue.withAlpha((255*0.4).round());
